...
<head>
    ...
    <title>SIPILJur SMAN 6 Pekanbaru</title>
    ...
    <!-- Page JS Plugins CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/js/plugins/slick/slick.css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/js/plugins/slick/slick-theme.css">
                ...
                <div class="content-side content-side-full content-side-user px-10 align-parent">
                    ...
                    <div class="sidebar-mini-hidden-b text-center">
                        <a class="img-link" href="be_pages_generic_profile.html">
                            <img class="img-avatar" src="<?= base_url() ?>assets/media/logo.jpg" alt="">
                        </a>
                        <ul class="list-inline mt-10">
                            <p>SMAN 6 Pekanbaru Riau</p>
                        </ul>
                    </div>
